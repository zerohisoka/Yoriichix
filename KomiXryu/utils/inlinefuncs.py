...
from komiXryu import arq
from komiXryu.services.keyboard import Ikb
from komiXryu.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from komiXryu.services.tasks import _get_tasks_text, all_tasks, rm_task
from komiXryu.services.types import InlineQueryResultCachedDocument
from komiXryu.modules.info import get_chat_info, get_user_info
from komiXryu.modules.music import download_youtube_audio
from komiXryu.utils.functions import test_speedtest
from komiXryu.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[Komi Robot ❤️](https://t.me/emikosupport):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
